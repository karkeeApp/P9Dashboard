...
const AdminSettingsForm: FC<AdminSettingsFormProps> = ({
  edit = false,
    ...
    switch (currentUser?.role) {
      case UserRole.MAIN_ADMIN:
        return (
          <Form.Item
            name='role'
            initialValue={UserRole.MAIN_ADMIN}
            label='Role'
            rules={[{ required: true, message: 'Please select role' }]}
          >
            <Select
              options={AdminRoleOptions.filter(
                (role) =>
      ...
      case UserRole.SUB_ADMIN:
        return (
          <Form.Item
            name='role'
            initialValue={UserRole.SUB_ADMIN}
            label='Role'
            rules={[{ required: true, message: 'Please select role' }]}
          >
            <Select disabled options={AdminRoleOptions} />
          </Form.Item>
        );
