...
export interface AdminVehicleDescriptionProps {
  admin: User;
}

const AdminVehicleDescription: FC<AdminVehicleDescriptionProps> = ({
  admin,
}) => {
...
export default AdminVehicleDescription;
