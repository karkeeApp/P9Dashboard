...
import { Row, Col, Card, Form, UploadProps, Modal, Upload } from 'antd';
...
export interface ListingGalleryFormProps {
  onRemove?: UploadProps['onRemove'];
}

const ListingGalleryForm: FC<ListingGalleryFormProps> = ({ onRemove }) => {
...
export default ListingGalleryForm;
